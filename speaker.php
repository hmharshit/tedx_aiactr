...
<body>
    ...
    <div class="join">
        <a href="registration.php" class="fa fa-plus-circle" style="color: #010101; font-size: 300px;"></a>
        <br>
    ...
    <div class="container-fluid">
    	<div class="row">
            <div class="gallery" ng-app="app">
                <figure ng-repeat="n in [].constructor(24) track by $index">
                    <img src="public/images/gallery/{{$index+1}}.jpg" alt="" />
                    <figcaption>TED<small>TEDx-AIACTR</small></figcaption>
                </figure>
            </div>
        </div> -->
